...
public class ArrayDequeTest {
    ...
    public void equalsMatchesEquivalentDequesTest() {
        ...
        ArrayDeque<Integer> sameArrayDeque = new ArrayDeque<>();
        LinkedListDeque<Integer> linkedListDeque = new LinkedListDeque<>();

        for (int i = 0; i < 5; i++) {
            arrayDeque.addLast(i);
            sameArrayDeque.addLast(i);
            linkedListDeque.addLast(i);
        }

        assertTrue(arrayDeque.equals(arrayDeque));
        assertTrue(arrayDeque.equals(sameArrayDeque));
    ...
    public void equalsRejectsDifferentObjectsTest() {
        ArrayDeque<Integer> deque = new ArrayDeque<>();
        ArrayDeque<Integer> differentContents = new ArrayDeque<>();
        ArrayDeque<Integer> differentSize = new ArrayDeque<>();
